...
% Chemistry & Biology -> Electrodes=1, Hydrovoltaic=1, ACY=2
\addplot[fill=colChem, draw=none] coordinates {
    (TEG,0)(PV,0)(Coil,0)(Rectenna,0)(MME,0)
    (TENG,0)(PZ,0)(EM,0)(Electrodes,1)(Hydrovoltaic,1)(ACY,2)};
\addlegendentry{Chemistry \& Biology}

\end{axis}
\end{tikzpicture}
\caption{Distribution of papers based on transducer type \cite{leonavilaEnergyHarvestingTechniques2025}.}
