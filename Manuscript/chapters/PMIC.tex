...
Table \ref{tab:pmic_aem13920_in} reports its input stage specifications.
...
The output voltage is regulated with a Buck converter connected to the storage element; Table \ref{tab:pmic_aem13920_out} reports its output stage specifications.
...
Table \ref{tab:pmic_aem10941_in} reports its input stage specifications.
...
The output voltage is regulated using a Buck converter with constant voltage (typ.\ $2.2\ \text{V}$) fed by the storage element. The IC additionally provides two \LDO{} outputs for low-noise, high-stability supplies; Table \ref{tab:pmic_aem10941_out} reports its output stage specifications.
...
Table \ref{tab:pmic_bq25570_in} reports its input stage specifications.
...
The output voltage is regulated with a Buck converter connected to the storage element; Table \ref{tab:pmic_bq25570_out} reports its output stage specifications.
...
Table \ref{tab:pmic_spv1050_out} reports its output stage specifications.
...
Table \ref{tab:pmic_spv1040_in} reports its input stage specifications.
