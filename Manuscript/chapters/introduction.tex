...
\begin{itemize}
    ...
    \item \emph{energy storage element}: is used to keep the device operating for a certain amount of time even if the source is weak or no longer present. Such element can be a capacitor/super capacitor or a rechargeable battery \cite{roundyStudyLowLevel2003a}.
\end{itemize}
...
is the number of teeth on the wheel. Following Faraday's law, the output
